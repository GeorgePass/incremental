      ...
      {!inDungeon && (
        <>
          <div className="location-buttons">
            ...
            <button onClick={() => setInDungeon(true)}>Enter Dungeon</button>
          </div>

          {/* Render sublocation content only if not in dungeon */}
 ...
 |  Town   |
  \\_______/
    ...
    |   |
      ...
      {inDungeon && (
        <Dungeon playerStats={playerStats} onExitDungeon={() => setInDungeon(false)} />
      )}
    </div>
  );
};
